...
export type TrackType = "video" | "text" | "audio" | "sticker" | "effect" | "prompt";
...
export interface PromptTrack extends BaseTrack {
	type: "prompt";
...
export interface PromptElement extends BaseTimelineElement {
  type: "prompt";
  id: string;
